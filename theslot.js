...
const FAMS = [
  ...
  {id:"whip",name:"The Whip family",n:"03",desc:"An eight-count pattern: led past, then redirected back. Three of them — the J-hook, the basket, and the reverse — and between them they're the deepest, branchiest part of the dance. Most of the fancy stuff you admire is one of these three with knobs turned."},
...
const MOVES = [
  ...
  // whip
  {id:"w-basic",fam:"whip",name:"J-Hook Whip",aka:"the whip, basic 8-count, inside whip",count:"1 2 3&4 5 6 7&8",diff:2,video:"https://www.youtube.com/watch?v=5vVeFs6q9os",blurb:"The eight-count that most of the dance is built on — led past, then redirected back to the end of the slot, with the follower's inside turn hooking her path into a J. Most of the WCS world just calls this 'the whip.' Here it's the J-hook, and it's the launchpad for a stack of endings."},
  {id:"w-basket",fam:"whip",name:"Basket Whip",aka:"sweetheart / lock / walkaround / cradle",diff:3,video:"https://www.youtube.com/playlist?list=PLeZ__vwnEDu8Lf_OAAuIhOHP5jK1UFBPF",blurb:"Both hands 'basket' the follower into a wrap, then release. One entry — and a fistful of different exit hands (and names, like the cradle) hang off it."},
  ...
  {id:"w-tommy",fam:"whip",name:"Texas Tommy",aka:"Apache",diff:4,builds:"J-Hook Whip",lever:"hand change",q:"west coast swing texas tommy whip",blurb:"A crossed-hand whip that wraps behind the back and unwinds. A classic that drills clean hand-offs."},
  {id:"w-bbhc",fam:"whip",name:"Behind-the-Back Hand Change",aka:"BBHC",diff:4,builds:"J-Hook Whip",lever:"hand change",q:"west coast swing behind the back hand change whip",blurb:"Pass the hand behind your own back mid-whip. A signature switch that itself sets up a stack of variations."},
  ...
  {id:"w-reverse",fam:"whip",name:"Reverse Whip",aka:"outside whip, whip w/ outside turn",diff:3,video:"https://www.youtube.com/watch?v=2Zvz7e_MXXo",blurb:"An eight-count that turns the follower outside instead of in — the mirror image of the J-hook. Depending on the room it's an outside whip or a whip with an outside turn; here it's the reverse whip. Several holds: normal, handshake, reverse."},
  ...
  {id:"w-freespin",fam:"whip",name:"Whip w/ Free Spin",diff:4,builds:"Reverse Whip",lever:"add a turn",video:"https://www.youtube.com/watch?v=HgASX23pVDE",blurb:"Release into an unassisted spin out of the whip. Now the follower's balance and your prep do all the work."},
  {id:"w-hustle",fam:"whip",name:"Hustle Whip",diff:4,builds:"J-Hook Whip",lever:"new entry",q:"west coast swing hustle whip",blurb:"A whip that borrows hustle's compact, quick redirect. New way in for a familiar 8-count."},
